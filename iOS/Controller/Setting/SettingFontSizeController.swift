...
class SettingFontSizeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let rootController = presentingViewController as? RootSplitViewController {
            rootController.contentViewController.webViewController.adjustFontSize(scale: selected)
        }
    }
}
