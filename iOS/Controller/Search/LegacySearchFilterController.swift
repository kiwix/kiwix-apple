...
class LegacySearchFilterController: UIViewController, UITableViewDelegate, UITableViewDataSource,
    ...
    func sectionHeaderButtonTapped(button: UIButton, section: LegacySearchFilterController.Section) {
        switch section {
        case .recentSearch:
